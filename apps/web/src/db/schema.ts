...
export const bookClubRoleEnum = pgEnum("book_club_role", [
  "owner",
  "admin",
  "member",
]);
...
export const readingLogs = pgTable(
  ...
  (table) => [
    ...
    index("reading_logs_user_created_idx").on(
      table.userId,
...
export const bookClubBookRatings = pgTable(
  ...
  (table) => [
    ...
    uniqueIndex("book_club_book_ratings_unique_idx").on(
      table.bookClubBookId,
      table.userId
    ),
    // For finding highest/lowest raters
    index("book_club_book_ratings_rating_idx").on(
      table.bookClubBookId,
      table.rating
    ),
  ]
...
export const bookClubVotes = pgTable(
  ...
  (table) => [
    ...
    uniqueIndex("book_club_votes_unique_idx").on(
      table.bookClubBookId,
      table.userId
    ),
  ]
...
export const bookClubInvites = pgTable(
  ...
  (table) => [
    ...
    uniqueIndex("book_club_invites_pending_idx").on(
      table.clubId,
      table.inviteeId
    ),
  ]
...
export const bookClubJoinRequests = pgTable(
  ...
  (table) => [
    ...
    uniqueIndex("book_club_join_requests_pending_idx").on(
      table.clubId,
      table.userId
    ),
  ]
